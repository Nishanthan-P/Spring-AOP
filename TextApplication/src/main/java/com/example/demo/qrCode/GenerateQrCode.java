...
//		String qrCodeText = "https://www.journaldev.com";
		String qrCodeText = "http://wantednote.com/";
//		String filePath = "Wn.png";
		String filePath = "src/main/resources/Wn1.png";
		int size = 125;
		String fileType = "png";
	...
	private static byte[] createQRImage(File qrFile, String qrCodeText, int size, String fileType)
		...
		ImageIO.write(image, fileType, qrFile);
		return IOUtils.toByteArray(qrFile.getAbsolutePath());
	}
}
